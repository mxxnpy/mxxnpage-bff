...
type NestJSReferenceConfiguration = ApiReferenceConfiguration & {
    withFastify?: boolean;
    cdn?: string;
};
type ApiReferenceOptions = ApiReferenceConfiguration & {
    cdn?: string;
};
/**
 ...
 */
declare function apiReference(options: NestJSReferenceConfiguration): ((_req: FastifyRequest, res: ServerResponse) => void) | ((_req: Request, res: Response) => void);
